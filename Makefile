...
CFLAGS += -fno-ident -DHAVE_ZLIB -DZ7_ST -DHAVE_COMPRESSION -DARCHIVE_USE_BUILTIN_DEFLATE -DHAVE_FLAC -DZSTD_DISABLE_ASM -DUSE_LIBRETRO_VFS
CXXFLAGS += -std=c++14 -fno-exceptions -fno-rtti -fno-ident -DHAVE_ZLIB -DZ7_ST -DHAVE_COMPRESSION -DARCHIVE_USE_BUILTIN_DEFLATE -DHAVE_FLAC -DZSTD_DISABLE_ASM -DUSE_LIBRETRO_VFS
